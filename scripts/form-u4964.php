...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>GET A FREE CONSULTATION:</b></td><td>' . htmlentities($_REQUEST["custom_U4978"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U4969"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cell Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U4965"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom:</b></td><td>' . htmlentities($_REQUEST["custom_U4985"],ENT_COMPAT,'UTF-8') . '</td></tr>';
